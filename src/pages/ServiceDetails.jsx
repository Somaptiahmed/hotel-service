...
//         setReviews((prev) => [result.review, ...prev]); // Add new review to the UI
//         setNewReview({
//           text: "",
//           rating: 0,
//           userName: userName || "",
...
const handleReviewSubmit = async (e) => {
    ...
    const reviewData = {
      userName: newReview.userName || "Anonymous", // Ensure userName is not empty
            ...
            {reviews.length === 0 ? (
              ...
              reviews.map((review) => (
                <div key={review._id} className="border-b py-4">
                  ...
                  <p className="text-sm text-gray-500 mt-2">Posted on: {new Date(review.postedDate).toLocaleDateString()}</p>
                </div>
              ))
            )}
    ...
    {Array.from({ length: 10 }, (_, index) => (
      <option key={index + 1} value={index + 1}>
        {index + 1}
                ...
                <button onChange={handleReviewSubmit}
                  type="submit"
...
//     text: "",
//     rating: 0,
//     userName: userName || "", // Get this from auth context
//     userPhoto: userPhoto || "", // Get this from auth context
//     postedDate: new Date().toISOString(),
//   });
...
//       ...newReview,
//       serviceId,
//       userEmail, // Assumes userEmail is available from the auth context
//     };
